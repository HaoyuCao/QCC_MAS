...
Usage:
    qcc-segment --dataset data/derm.jsonl --fields case_vignette --model gpt-5-mini
"""
...
Examples:
  # Basic segmentation
  qcc-segment --dataset data/derm.jsonl --fields case_vignette

  # Multiple fields with custom output
  qcc-segment --dataset data/cases.jsonl --fields patient_history,examination \\
              --out data/cases_segmented.jsonl

  # Parallel processing with more workers
  qcc-segment --dataset data/large_dataset.jsonl --fields case_vignette \\
